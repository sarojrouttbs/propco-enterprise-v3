...
var hmrc = function () {
    ...
    this.waitForHMRCPageToLoad = function () {
        browser.sleep(3000)
    ...
    this.selectTableRecord = function () {
        ...
        commonFunction.clickOnElement(this.selectFirstRecord)
    }

    this.navigateToNextScreen = function () {
        commonFunction.scrollToElement(this.nextButton)
        commonFunction.clickOnElement(this.nextButton)
    }
    ...
    this.clickOnSendButton = function () {
        ...
        commonFunction.clickOnElement(this.sendButton)
        commonFunction.waitForElementToBeVisible(this.confirmButton, "Confirm Button")
        commonFunction.clickOnElement(this.confirmButton)
    }
    ...
    this.validateFinish = function () {
        ...
        commonFunction.clickOnElement(this.finishBUtton)

        commonFunction.waitForElementToBeVisible(this.finishFinalButton, "Finish Button")
        commonFunction.clickOnElement(this.finishFinalButton)
