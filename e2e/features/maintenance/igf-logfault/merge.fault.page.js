...
var MergeFault = function (faultDetails) {
    ...
    this.closePopupReasonList = element(by.xpath("//ion-select[@formcontrolname='closedReason']"));
    ...
    this.moreFilterSearchInput = element(by.xpath("//ion-modal//input[@type='search']"));
    ...
    this.showEntriesList = element(by.xpath("//select[@name='faultListTable_length']"));
    ...
    this.mergeFaults = function(mergedFault){  
       ...
       // commonFunction.clickOnElement(this.showEntriesList, "Show Entries list");
       // commonFunction.clickOnElement(element(by.xpath("//select[@name='faultListTable_length']//option[@value='15']")), "Number of rows");
       // browser.sleep(3000);
        commonFunction.waitForElementToBeVisible(addFault.actionBtn, "Action button for first fault"); 
        if(mergedFault.parentFaultIndex){
    ...
    this.searchByMoreFilter = function(filterType, filterValues){
        ...
        commonFunction.waitForElementToBeVisible(this.moreFilterSearchInput, "Search input");
