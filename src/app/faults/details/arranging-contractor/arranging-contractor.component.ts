...
export class ArrangingContractorComponent implements OnInit {
  ...
  private initQuoteForm(): void {
    this.raiseQuoteForm = this.fb.group({
      ...
      description: [(this.faultDetails.sourceType === 'FAULT' ? (this.categoryName + ' ' + this.faultDetails.title) : (this.faultDetails.fixfloCategory + ' ' + this.faultDetails.title)), [Validators.required, Validators.maxLength(255)]],
