...
import { ImagePageModule } from 'src/app/agent/workspace/property/property-modal/image/image.module';
...
import { CallInfoModalPageModule } from 'src/app/agent/workspace/property/property-modal/call-info-modal/call-info-modal.module';
...
import { PeriodicVisitModalPageModule } from 'src/app/agent/workspace/property/property-modal/periodic-visit-modal/periodic-visit-modal.module';
...
import { ChangeNettPageModule } from 'src/app/agent/workspace/property/property-modal/change-nett/change-nett.module';
import { ChangeGrossPageModule } from 'src/app/agent/workspace/property/property-modal/change-gross/change-gross.module';
import { FeeChargePageModule } from 'src/app/agent/workspace/property/property-modal/fee-charge/fee-charge.module';
import { NotesComponent } from './admin/notes/notes.component';
import { KeysComponent } from './admin/keys/keys.component';
import { KeyActivityModalPageModule } from './property-modal/key-activity-modal/key-activity-modal.module';
...
import { CreateKeySetPageModule } from 'src/app/agent/workspace/property/property-modal/create-key-set/create-key-set.module';
